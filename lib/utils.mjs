 ...
 * @return  {void}
 */
export function addMethod(names, fn){
 ...
 * @return  {void}
 */
export function addProperty(names, fn){
	for(const name of "string" === typeof names ? [names] : names)
 ...
 * @return {void}
 */
export function defineAssertion(names, handler){
 ...
 * @return {void}
 */
export function defineAssertions(spec){
 ...
 * @internal
 */
export function flattenList(input, refs = null){
 ...
 * @internal
 */
export function formatList(list, rel = "and"){
